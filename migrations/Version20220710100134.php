...
final class Version20220710100134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE link_metadata (id UUID NOT NULL, link_id UUID DEFAULT NULL, title TEXT NOT NULL, description TEXT NULL, extra JSONB NOT NULL, fetched TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
